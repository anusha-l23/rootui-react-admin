                        ...
                        <div className="block-example border border-top-0 border-gray p-4 border-1">
                            ...
                            <Form onSubmit={ ( e ) => {
                                ...
                                <div className="form-row">
                                    ...
                                    <div className="form-group col-md-6"></div>
                                    <div className="form-group col-md-6">
                                        <Input type="text" className="form-control" id="firstname" name="firstName" onChange={ this.formik.handleChange }
                                            onBlur={ this.formik.handleBlur }
                                    ...
                                    <div className="form-group col-md-6">
                                        ...
                                        <Input type="text"className="form-control" id="lastname" name="lastName" onChange={ this.formik.handleChange }
                                            onBlur={ this.formik.handleBlur }
                                    ...
                                    <div className="form-group col-md-6">
                                        ...
                                        <Input type="email"className="form-control" id="email" name="email" onChange={ this.formik.handleChange }
                                            onBlur={ this.formik.handleBlur }
                                    ...
                                    <div className="form-group col-md-4">
                                        <Input type="radio" id="s" style={ { transform: 'scale(1.5)', marginLeft: "0.1em" } } name="tShirtSize" value="S" checked={ this.formik.values.tShirtSize === "S" } onChange={ this.formik.handleChange } required />
                                        <label htmlFor="s" style={ { marginLeft: "2em" } }>S</label>
                                    </div>
    
                                    <div className="form-group col-md-4">
                                        <Input type="radio" id="m" style={ { transform: 'scale(1.5)', marginLeft: "0.1em" } } name="tShirtSize" value="M" checked={ this.formik.values.tShirtSize === "M" } onChange={ this.formik.handleChange } required />
                                        <label htmlFor="m" style={ { marginLeft: "2em" } }>M</label>
                                    </div>
                                    <div className="form-group col-md-4">
                                        <Input type="radio" id="l" style={ { transform: 'scale(1.5)', marginLeft: "0.1em" } } name="tShirtSize" value="L" checked={ this.formik.values.tShirtSize === "L" } onChange={ this.formik.handleChange } required />
                                        <label htmlFor="l" style={ { marginLeft: "2em" } }>L</label>
                                    </div>
                                    <div className="form-group col-md-4">
                                        <Input type="radio" id="xl" style={ { transform: 'scale(1.5)', marginLeft: "0.1em" } } name="tShirtSize" value="XL" checked={ this.formik.values.tShirtSize === "XL" } onChange={ this.formik.handleChange } required />
                                        <label htmlFor="xl" style={ { marginLeft: "2em" } }>XL</label>
                                    
                                    </div>
                                    <div className="form-group col-md-4">
                                        <Input type="radio" id="xxl" style={ { transform: 'scale(1.5)', marginLeft: "0.1em" } } name="tShirtSize" value="XXL" checked={ this.formik.values.tShirtSize === "XXL" } onChange={ this.formik.handleChange } required />
                                    ...
                                    <div className="form-group col-md-6">
                                        ...
                                        <Input type="text"className="form-control" id="emergencycontactname" name="contactName" onChange={ this.formik.handleChange }
                                            onBlur={ this.formik.handleBlur }
                                    ...
                                    <div className="form-group col-md-6">
                                        ...
                                        <Input type="text"className="form-control" id="emergencycontactnumber" name="contactNumber" onChange={ this.formik.handleChange }
                                            onBlur={ this.formik.handleBlur }
                                            placeholder={ this.state.placeholder }
                                            onMouseEnter={ this.handleHover }
                                            onMouseLeave={ this.handleMouseOut }
